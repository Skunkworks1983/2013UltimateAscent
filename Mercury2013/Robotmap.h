...
#define DRIVE_ENCODER_TICKS_PER_REV_HIGH		(400.0)
#define DRIVE_ENCODER_TICKS_PER_REV_LOW			(250.0)
#define DRIVE_WHEEL_DIAMETER					(4.0)
#define DRIVE_ENCODER_INCH_PER_TICK_HIGH		((DRIVE_WHEEL_DIAMETER * 3.14159)/DRIVE_ENCODER_TICKS_PER_REV_HIGH)
#define DRIVE_ENCODER_INCH_PER_TICK_LOW			((DRIVE_WHEEL_DIAMETER * 3.14159)/DRIVE_ENCODER_TICKS_PER_REV_HIGH)
